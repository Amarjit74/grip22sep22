...
<head>
    ...
    left: 0;
    z-index: 20;
    background:  rgb(212,205,100) center no-repeat;
    text-align:center;
        }
...
<body style="background-color:#15317E;">
...
<div id="container">
    ...
    <div class="container-large"
        style="color:white; height:550px; width: 100%; padding:8% 2% 2% 2%; background-color:#2B1B17;">
       <marquee> <h1> Welcome to all new Customer in our Spark Local Bank</h1> </marquee>
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> Sparks Local
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:0% 0% 2% 5%; text-align:center;">
                &nbsp;<img src="assets/fin1.png" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
